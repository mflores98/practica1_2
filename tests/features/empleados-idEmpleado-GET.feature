Feature: /empleados/{idempleado} GET
    ...
    Scenario Outline: /empleados/{idempleado} 200 ok.

        Given I set bearer token
        And I have valid client TLS configuration
      
        When I GET `apigeeDomain`/banca-digital/empleados/`deploymentSuffix`/<idempleado>
    ...
    Scenario Outline: /empleados/{idempleado} 400 bad request.
    ...
    Scenario Outline: /empleados/{idempleado} 404 not found.
    ...
    Scenario Outline: /empleados/{idempleado} 500 internal server error.
